...
from pubg_match_analyzer.services.match_details import build_match_overview, extract_player_stats, extract_team_summaries
...
apply_global_styles()
render_page_header("对局列表", "从候选结果中选择，或直接输入 match_id 载入对局详情。")
...
if matches:
    ...
    render_empty_state("当前还没有候选对局。你也可以直接手动输入 match_id。")
...
target_match_id = st.session_state.manual_match_id_input.strip() or st.session_state.selected_candidate_match_id.strip()
